document.addEventListener("DOMContentLoaded", () => {
  ...
  function addMessage(text, type) {
    ...
    if (match) {
      ...
      // Si la URL es de Cloudinary, se le agrega una transformación para 300x300 píxeles.
      if (imageUrl.includes("res.cloudinary.com")) {
        // Inserta "w_300,h_300,c_fill" después de "/upload/" para redimensionar y recortar
        imageUrl = imageUrl.replace("/upload/", "/upload/w_300,h_300,c_fill/");
      }
      img.src = imageUrl;
